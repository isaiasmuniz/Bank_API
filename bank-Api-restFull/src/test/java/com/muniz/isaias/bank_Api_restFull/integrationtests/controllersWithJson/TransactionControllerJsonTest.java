...
class TransactionControllerJsonTest extends AbstractIntegration {
    ...
    void deposit() throws JsonProcessingException {
        ...
        assertNotNull(peristedAccount.getAccountId());
        assertNotNull(persistedTargetAccount.getAccountId());

        assertEquals("samanta", persistedTargetAccount.getUser().getName());
        assertEquals("samanta@gmail.com", persistedTargetAccount.getUser().getEmail());
        assertEquals("adm123", persistedTargetAccount.getUser().getPassword());
